...
export default function AgentTransactionReportPage() {
  ...
  const filteredTransactions = useMemo(() => {
    ...
    return filtered;
  }, [transactions, searchQuery, agentFilter, dateFilter]);
  ...
  const handleExportExcel = () => {
    ...
    const headers = ["Date", "Agent Name", "Description", "Category", "Type", "Amount", "Balance After"];
    ...
    link.download = `agent_transaction_report_${format(new Date(), "yyyyMMdd")}.csv`;
    link.click();
  };
  ...
  const handlePrintPdf = async () => {
    ...
    const printContent = `
      ...
      <html>
        <head>
          <title>Agent Transaction Report</title>
          <style>
        ...
        <body>
          ...
          <p class="report-title">AGENT TRANSACTION REPORT</p>
  ...
  const isLoading = isLoadingAgents || isLoadingTransactions;
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            View all agent credit and deposit transactions with filters and export
          </p>
        </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm">Adjust filters or add agent transactions</p>
            </div>
          ) : (
